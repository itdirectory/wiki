...
- Further down the same page is a **Delete Organization** danger-zone section — this deletes the organization itself (not a sub-org). Treat it with the same caution as deleting a sub-org (see [creating-sub-organizations.md](creating-sub-organizations.md) for the equivalent confirmation pattern), but be aware this is your root organization, not a child of it.
