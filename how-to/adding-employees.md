...
- Adding an employee counts against your organization's pooled asset limit — see [billing.md](billing.md).
- Employees can also be bulk-imported via the **Import** button, or synced automatically from Microsoft Entra ID — see [connectors.md](connectors.md).
