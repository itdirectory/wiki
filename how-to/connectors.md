...
12. This connector reuses your organization's Entra ID credentials — if you haven't configured those yet, you'll see a prompt to go to **Settings → SSO — Entra ID** first (see [sso-setup.md](sso-setup.md)). Come back here afterward.
