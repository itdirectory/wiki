...
- Every root organization has a pooled asset/sub-org limit tied to its billing plan. If you're at your sub-org limit, creating a new one fails with "You've reached your sub-organization limit — contact us to upgrade" — see https://docs.itdirectory.app/tutorials/billing.
- To grant a Company Admin/Technician access to specific sub-orgs, do that from **Settings → Users** — see https://docs.itdirectory.app/tutorials/user-management.
